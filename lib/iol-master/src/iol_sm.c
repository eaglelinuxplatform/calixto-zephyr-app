...
#include <iol-master/iol_dl.h> /* DL_Read_req DL_Write_req DL_SetMode_req */
#include <iol-master/iol_mw.h> /* AL_Read_req AL_Write_req */
#include "iol-master/iol_pl.h" /* PL_SetMode_req */
#include "iol-master/iol_main.h" /* iolink_fetch_avail_job, iolink_post_job, iolink_get_portnumber */
